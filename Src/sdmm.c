...
#define DO HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_7)

#define DI_INIT()
#define DI_H()		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_SET)
#define DI_L()		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET)
...
static
int sselect (void)	/* 1:OK, 0:Timeout */
{
	BYTE d;
